...
namespace Envoy.Config.Filter.Network.Rbac.V3Alpha {

  /// <summary>Holder for reflection information generated from envoy/config/filter/network/rbac/v3alpha/rbac.proto</summary>
  public static partial class RbacReflection {

    #region Descriptor
    /// <summary>File descriptor for envoy/config/filter/network/rbac/v3alpha/rbac.proto</summary>
    ...
    static RbacReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "CjNlbnZveS9jb25maWcvZmlsdGVyL25ldHdvcmsvcmJhYy92M2FscGhhL3Ji",
            "YWMucHJvdG8SKGVudm95LmNvbmZpZy5maWx0ZXIubmV0d29yay5yYmFjLnYz",
            "YWxwaGEaJGVudm95L2NvbmZpZy9yYmFjL3YzYWxwaGEvcmJhYy5wcm90bxoX",
            "dmFsaWRhdGUvdmFsaWRhdGUucHJvdG8ipgIKBFJCQUMSLgoFcnVsZXMYASAB",
            "KAsyHy5lbnZveS5jb25maWcucmJhYy52M2FscGhhLlJCQUMSNQoMc2hhZG93",
            "X3J1bGVzGAIgASgLMh8uZW52b3kuY29uZmlnLnJiYWMudjNhbHBoYS5SQkFD",
            "Eh4KC3N0YXRfcHJlZml4GAMgASgJQgm66cADBHICIAESWAoQZW5mb3JjZW1l",
            "bnRfdHlwZRgEIAEoDjI+LmVudm95LmNvbmZpZy5maWx0ZXIubmV0d29yay5y",
            "YmFjLnYzYWxwaGEuUkJBQy5FbmZvcmNlbWVudFR5cGUiPQoPRW5mb3JjZW1l",
            "bnRUeXBlEhoKFk9ORV9USU1FX09OX0ZJUlNUX0JZVEUQABIOCgpDT05USU5V",
            "T1VTEAFCRQo2aW8uZW52b3lwcm94eS5lbnZveS5jb25maWcuZmlsdGVyLm5l",
            "dHdvcmsucmJhYy52M2FscGhhQglSYmFjUHJvdG9QAWIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::Envoy.Config.Rbac.V3Alpha.RbacReflection.Descriptor, global::Validate.ValidateReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC), global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC.Parser, new[]{ "Rules", "ShadowRules", "StatPrefix", "EnforcementType" }, null, new[]{ typeof(global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC.Types.EnforcementType) }, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class RBAC : pb::IMessage<RBAC> {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RbacReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::Envoy.Config.Rbac.V3Alpha.RBAC rules_;
    /// <summary>
    /// Specify the RBAC rules to be applied globally.
    /// If absent, no enforcing RBAC policy will be applied.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Envoy.Config.Rbac.V3Alpha.RBAC Rules {
      get { return rules_; }
      set {
        rules_ = value;
      }
    ...
    private global::Envoy.Config.Rbac.V3Alpha.RBAC shadowRules_;
    /// <summary>
    ...
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Envoy.Config.Rbac.V3Alpha.RBAC ShadowRules {
    ...
    private global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC.Types.EnforcementType enforcementType_ = global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC.Types.EnforcementType.OneTimeOnFirstByte;
    /// <summary>
    ...
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC.Types.EnforcementType EnforcementType {
    ...
    public override int GetHashCode() {
      ...
      if (EnforcementType != global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC.Types.EnforcementType.OneTimeOnFirstByte) hash ^= EnforcementType.GetHashCode();
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 32: {
            EnforcementType = (global::Envoy.Config.Filter.Network.Rbac.V3Alpha.RBAC.Types.EnforcementType) input.ReadEnum();
            break;
          }
        }
      }
