...
namespace Envoy.Config.Filter.Http.HealthCheck.V3Alpha {

  /// <summary>Holder for reflection information generated from envoy/config/filter/http/health_check/v3alpha/health_check.proto</summary>
  public static partial class HealthCheckReflection {

    #region Descriptor
    /// <summary>File descriptor for envoy/config/filter/http/health_check/v3alpha/health_check.proto</summary>
    ...
    static HealthCheckReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "CkBlbnZveS9jb25maWcvZmlsdGVyL2h0dHAvaGVhbHRoX2NoZWNrL3YzYWxw",
            "aGEvaGVhbHRoX2NoZWNrLnByb3RvEi1lbnZveS5jb25maWcuZmlsdGVyLmh0",
            "dHAuaGVhbHRoX2NoZWNrLnYzYWxwaGEaHmdvb2dsZS9wcm90b2J1Zi9kdXJh",
            "dGlvbi5wcm90bxoeZ29vZ2xlL3Byb3RvYnVmL3dyYXBwZXJzLnByb3RvGiNl",
            "bnZveS9hcGkvdjNhbHBoYS9yb3V0ZS9yb3V0ZS5wcm90bxoYZW52b3kvdHlw",
            "ZS9wZXJjZW50LnByb3RvGhd2YWxpZGF0ZS92YWxpZGF0ZS5wcm90byKqAwoL",
            "SGVhbHRoQ2hlY2sSQQoRcGFzc190aHJvdWdoX21vZGUYASABKAsyGi5nb29n",
            "bGUucHJvdG9idWYuQm9vbFZhbHVlQgq66cADBYoBAhABEi0KCmNhY2hlX3Rp",
            "bWUYAyABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb24ShQEKH2NsdXN0",
            "ZXJfbWluX2hlYWx0aHlfcGVyY2VudGFnZXMYBCADKAsyXC5lbnZveS5jb25m",
            "aWcuZmlsdGVyLmh0dHAuaGVhbHRoX2NoZWNrLnYzYWxwaGEuSGVhbHRoQ2hl",
            "Y2suQ2x1c3Rlck1pbkhlYWx0aHlQZXJjZW50YWdlc0VudHJ5EjcKB2hlYWRl",
            "cnMYBSADKAsyJi5lbnZveS5hcGkudjNhbHBoYS5yb3V0ZS5IZWFkZXJNYXRj",
            "aGVyGlgKIUNsdXN0ZXJNaW5IZWFsdGh5UGVyY2VudGFnZXNFbnRyeRILCgNr",
            "ZXkYASABKAkSIgoFdmFsdWUYAiABKAsyEy5lbnZveS50eXBlLlBlcmNlbnQ6",
            "AjgBSgQIAhADUghlbmRwb2ludEJRCjtpby5lbnZveXByb3h5LmVudm95LmNv",
            "bmZpZy5maWx0ZXIuaHR0cC5oZWFsdGhfY2hlY2sudjNhbHBoYUIQSGVhbHRo",
            "Q2hlY2tQcm90b1ABYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Envoy.Config.Filter.Http.HealthCheck.V3Alpha.HealthCheck), global::Envoy.Config.Filter.Http.HealthCheck.V3Alpha.HealthCheck.Parser, new[]{ "PassThroughMode", "CacheTime", "ClusterMinHealthyPercentages", "Headers" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, })
          }));
    }
    #endregion
  ...
  public sealed partial class HealthCheck : pb::IMessage<HealthCheck> {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Envoy.Config.Filter.Http.HealthCheck.V3Alpha.HealthCheckReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private static readonly pb::FieldCodec<global::Envoy.Api.V3Alpha.Route.HeaderMatcher> _repeated_headers_codec
        = pb::FieldCodec.ForMessage(42, global::Envoy.Api.V3Alpha.Route.HeaderMatcher.Parser);
