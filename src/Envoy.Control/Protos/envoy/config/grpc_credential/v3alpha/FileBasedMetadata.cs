...
namespace Envoy.Config.GrpcCredential.V3Alpha {
  ...
  /// <summary>Holder for reflection information generated from envoy/config/grpc_credential/v3alpha/file_based_metadata.proto</summary>
  public static partial class FileBasedMetadataReflection {

    #region Descriptor
    /// <summary>File descriptor for envoy/config/grpc_credential/v3alpha/file_based_metadata.proto</summary>
    ...
    static FileBasedMetadataReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cj5lbnZveS9jb25maWcvZ3JwY19jcmVkZW50aWFsL3YzYWxwaGEvZmlsZV9i",
            "YXNlZF9tZXRhZGF0YS5wcm90bxIkZW52b3kuY29uZmlnLmdycGNfY3JlZGVu",
            "dGlhbC52M2FscGhhGiFlbnZveS9hcGkvdjNhbHBoYS9jb3JlL2Jhc2UucHJv",
            "dG8ifQoXRmlsZUJhc2VkTWV0YWRhdGFDb25maWcSNwoLc2VjcmV0X2RhdGEY",
            "ASABKAsyIi5lbnZveS5hcGkudjNhbHBoYS5jb3JlLkRhdGFTb3VyY2USEgoK",
            "aGVhZGVyX2tleRgCIAEoCRIVCg1oZWFkZXJfcHJlZml4GAMgASgJQk4KMmlv",
            "LmVudm95cHJveHkuZW52b3kuY29uZmlnLmdycGNfY3JlZGVudGlhbC52M2Fs",
            "cGhhQhZGaWxlQmFzZWRNZXRhZGF0YVByb3RvUAFiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::Envoy.Api.V3Alpha.Core.BaseReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Envoy.Config.GrpcCredential.V3Alpha.FileBasedMetadataConfig), global::Envoy.Config.GrpcCredential.V3Alpha.FileBasedMetadataConfig.Parser, new[]{ "SecretData", "HeaderKey", "HeaderPrefix" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class FileBasedMetadataConfig : pb::IMessage<FileBasedMetadataConfig> {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Envoy.Config.GrpcCredential.V3Alpha.FileBasedMetadataReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::Envoy.Api.V3Alpha.Core.DataSource secretData_;
    /// <summary>
    /// Location or inline data of secret to use for authentication of the Google gRPC connection
    /// this secret will be attached to a header of the gRPC connection
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Envoy.Api.V3Alpha.Core.DataSource SecretData {
    ...
    public void MergeFrom(FileBasedMetadataConfig other) {
      ...
      if (other.secretData_ != null) {
        if (secretData_ == null) {
          SecretData = new global::Envoy.Api.V3Alpha.Core.DataSource();
        }
